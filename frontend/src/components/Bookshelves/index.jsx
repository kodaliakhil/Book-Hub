...
function Bookshelves () {
  ...
  const getUpdatedBookData = eachBook => ({
  ...
  const updatedActiveShelf = activeShelf => {
              ...
              <ul className="shelf-items-container">
                {bookshelvesList.map(eachShelfItem => (
                  <ShelfItem
                    ...
                    updatedActiveShelf={updatedActiveShelf}
                  />
                ))}
              </ul>
            </div>
          ...
          <>
            <div className="all-books-container">
              <div className="left-side-books-container">
                {renderBooks(leftSideBooksList)}
              </div>
              <div className="right-side-books-container">
                {renderBooks(rightSideBooksList)}
              </div>
            </div>
            <Footer />
          </>
  ...
  const renderHeaderAndBooksSection = () => (
